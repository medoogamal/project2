...
const submitForm = async () => {
  ...
  if (result) {
    Swal.fire({
      ...
      router.push(`/${languageStore.langUrl}`)
    })
  } else {
    Swal.fire({
      title: 'Error!',
      text: 'Make the validation correctly',
      icon: 'error',
      confirmButtonText: 'Cool'
    })
  }
              ...
              <form @submit.prevent="submitForm">
                ...
                <div class="relative mb-6" data-te-input-wrapper-init>
                  ...
                  <label
                    ...
                    class="peer-focus:dark:bg-[#1a1a1a] peer-focus:px-2 peer-focus:bg-white pointer-events-none absolute top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.95] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary"
                    >Email address
                  </label>
                ...
                <div class="mb-6 flex items-center justify-between">
                  ...
                  <a
                    href="#!"
                    class="text-primary dark:text-white hover:text-[#ffc600] transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-primary-600"
                    >Forgot password?</a
                  >
                  <router-link
                    :to="`/${languageStore.langUrl}/profile/register`"
